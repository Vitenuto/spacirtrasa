...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function(@JsonKey(name: "map_entity_id")  String mapEntityId,  String text,  MapEntityType type)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Note() when $default != null:
return $default(_that.mapEntityId,_that.text,_that.type);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function(@JsonKey(name: "map_entity_id")  String mapEntityId,  String text,  MapEntityType type)  $default,) {final _that = this;
switch (_that) {
case _Note():
return $default(_that.mapEntityId,_that.text,_that.type);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function(@JsonKey(name: "map_entity_id")  String mapEntityId,  String text,  MapEntityType type)?  $default,) {final _that = this;
switch (_that) {
case _Note() when $default != null:
return $default(_that.mapEntityId,_that.text,_that.type);case _:
  return null;

...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id, @JsonKey(name: 'is_admin')  bool isAdmin, @JsonKey(name: 'favorite_poi_ids')  List<String> favoritePoiIds, @JsonKey(name: 'favorite_trail_ids')  List<String> favoriteTrailIds, @JsonKey(name: 'finished_trails')  List<FinishedTrail> finishedTrails,  List<Note> notes)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _AppUser() when $default != null:
return $default(_that.id,_that.isAdmin,_that.favoritePoiIds,_that.favoriteTrailIds,_that.finishedTrails,_that.notes);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id, @JsonKey(name: 'is_admin')  bool isAdmin, @JsonKey(name: 'favorite_poi_ids')  List<String> favoritePoiIds, @JsonKey(name: 'favorite_trail_ids')  List<String> favoriteTrailIds, @JsonKey(name: 'finished_trails')  List<FinishedTrail> finishedTrails,  List<Note> notes)  $default,) {final _that = this;
switch (_that) {
case _AppUser():
return $default(_that.id,_that.isAdmin,_that.favoritePoiIds,_that.favoriteTrailIds,_that.finishedTrails,_that.notes);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id, @JsonKey(name: 'is_admin')  bool isAdmin, @JsonKey(name: 'favorite_poi_ids')  List<String> favoritePoiIds, @JsonKey(name: 'favorite_trail_ids')  List<String> favoriteTrailIds, @JsonKey(name: 'finished_trails')  List<FinishedTrail> finishedTrails,  List<Note> notes)?  $default,) {final _that = this;
switch (_that) {
case _AppUser() when $default != null:
return $default(_that.id,_that.isAdmin,_that.favoritePoiIds,_that.favoriteTrailIds,_that.finishedTrails,_that.notes);case _:
  return null;

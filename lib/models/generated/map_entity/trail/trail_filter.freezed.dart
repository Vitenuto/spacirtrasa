...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( (double, double) bounds,  String searchText,  TrailFlag? flag)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _TrailFilter() when $default != null:
return $default(_that.bounds,_that.searchText,_that.flag);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( (double, double) bounds,  String searchText,  TrailFlag? flag)  $default,) {final _that = this;
switch (_that) {
case _TrailFilter():
return $default(_that.bounds,_that.searchText,_that.flag);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( (double, double) bounds,  String searchText,  TrailFlag? flag)?  $default,) {final _that = this;
switch (_that) {
case _TrailFilter() when $default != null:
return $default(_that.bounds,_that.searchText,_that.flag);case _:
  return null;
